...
This SOP defines when human review is required for AI-supported outputs and how issues should be escalated.
...
- Is included in management reporting
...
4. Review for bias, unfairness, or inappropriate interpretation.
5. Document corrections or conditions.
...
- Users are relying on AI beyond approved scope
- A vendor or tool behaves unexpectedly
...
4. Privacy/security lead reviews sensitive data or cyber risk.
5. AI governance lead determines whether use should pause, continue, or be revised.
6. Decision and corrective action are logged.
