...
This policy defines acceptable and prohibited uses of generative AI tools in an organizational setting.
...
- Supporting code review or query drafting where outputs are validated
- Preparing internal learning materials
...
- Replace required professional judgment
- Bypass access controls, records retention, privacy, security, or procurement requirements
...
- Approved tools only for sensitive business use
- Escalation of material errors or suspected privacy/security issues
